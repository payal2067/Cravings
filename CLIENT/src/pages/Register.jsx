...
const Register = () => {
  ...
  const inputClass =
    "border p-2 rounded focus:outline-none focus:ring-2 focus:ring-(--error)";

  return (
    <>
      <div className="min-h-[90vh] bg-linear-to-r from-(--secondary) to-(--primary) grid grid-cols-2 p-10">
        <div className="hidden md:block">
          <img src={deliveryboy} alt="" className="rotate-y-180 pe-56 pt-28" />
        </div>
        <div className="w-2xl bg-(--base-100) rounded shadow card p-10 flex flex-col justify-center">
